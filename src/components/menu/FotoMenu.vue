<template>
  <div v-if="listaFotosFiltradas.length > 1" class="">
    <v-carousel cycle hide-delimiters show-arrows="hover" height="300">
      <div v-for="foto in listaFotosFiltradas" :key="foto.id" class="">
        <v-carousel-item>
          <v-img class="borde-imagen" width="400" height="300" aspect-ratio="16/9" cover lazy-src="/fotos/pabellon.jpg"
  ...
  <div v-else-if="listaFotosFiltradas.length === 1" class="">
    <v-img class="borde-imagen" width="400" height="300" aspect-ratio="16/9" cover lazy-src="/fotos/pabellon.jpg"
      :src="listaFotosFiltradas[0].direccionUrl"></v-img>
  </div>
  <v-img v-else class="borde-imagen" width="400" height="300" aspect-ratio="16/9" cover src="/fotos/pabellon.jpg">
  </v-img>
</template>
